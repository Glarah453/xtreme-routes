...
drop PROCEDURE crear_sesion;
drop PROCEDURE cerrar_sesion;


drop PROCEDURE crear_sector;
drop procedure crear_sector_en_post;
drop procedure actualizar_sector;
drop procedure eliminar_sector;


drop PROCEDURE crear_ruta;
drop procedure crear_ruta_en_post;
drop PROCEDURE actualizar_ruta;
drop PROCEDURE eliminar_ruta;

drop PROCEDURE crear_post;
drop PROCEDURE actualizar_post;
drop PROCEDURE eliminar_post;

drop PROCEDURE crear_comentario;
drop PROCEDURE actualizar_comentario;
drop PROCEDURE eliminar_comentario;

drop PROCEDURE crear_valoracion;
drop PROCEDURE actualizar_valoracion;
drop PROCEDURE eliminar_valoracion;

drop PROCEDURE crear_me_gusta;
drop PROCEDURE eliminar_me_gusta;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM comunas WHERE id = p_comuna_id) THEN
        RAISE EXCEPTION 'Comuna no encontrada: %', p_comuna_id;
    END IF;
...
-- Procedimiento para crear una sesión
